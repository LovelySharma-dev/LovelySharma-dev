...
- 🥇 **Winner** — Hackathon @ KIET University: *OpenAIVerse – Decentralized AI Collaboration Platform*
- 🎯 **Frequent Participant** — National-level Hackathons (AI Hackathon, Google Cloud, Dataverse)
- ✅ **Web Development Complete Course** — Chai aur Code, Cohort 1.0
- 🐙 GitHub **Pull Shark ×2**, **YOLO**, **Quickdraw** achievements
